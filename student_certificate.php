...
<div class="left-sidebar bg-black-300 box-shadow ">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Students Details</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="#"><i class="fa fa-bars"></i> <span>View Student Details</span></a></li>
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="#"><i class="fa fa-bars"></i> <span>View Certificates</span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Display Certificates</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Students</li>
            							<li class="active">Display Certificates</li>
            						</ul>
                                </div>
